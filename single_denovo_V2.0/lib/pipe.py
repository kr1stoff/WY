...
class Pipe():
    ...
    def get_var(self):
        ...
        self.p_repeat = os.path.join(self.out,'3.pre','repeat')
        ...
        self.p_plasmid = os.path.join(self.out,'4.anno','plasmid')
        ...
        if self.PE_flag:
            ...
            self.clean_fq1 = os.path.join(self.p_fastp,f"{self.id}.clean.fq.gz")
            self.clean_fq2 = ''
            self.clean_fq = self.clean_fq1

            self.depollute_fq1 = os.path.join(self.p_deal,'depollute.fq')
            self.depollute_fq2 = ''
            self.depollute_fq = self.depollute_fq1

            self.cutfq1 = os.path.join(self.p_deal,'cut.fq')
            self.cutfq2 = ''
