...
!(function ($) {
    ...
    $.fn.jumpto = function (options) {
        ...
        block.find(settings.firstLevel).each(function (index) {
            ...
            var html_icon_first = "<img class='jumpto-icon-first' src='" + getIcon(b) + "'>";
