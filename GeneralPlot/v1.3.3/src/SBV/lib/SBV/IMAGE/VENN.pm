...
sub _venn3
{
	...
	{
		# label 1
        my $label1 = SBV::DRAW::text($name1,$cx1,$y1,class=>"label",yalign=>"bottom",parent=>$parent,id=>"label1");
		...
		# label 2 
        my $label2 = SBV::DRAW::text($name2,$cx2,$y2,class=>"label",yalign=>"bottom",parent=>$parent,id=>"label2");
		...
		# label 3
		my $label3 = SBV::DRAW::text($name3,$cx3,$y3,class=>"label",yalign=>"bottom",parent=>$parent,id=>"label3");
	}
	# venn stat result 
...
sub _venn4
{
	...
	if ($conf->{show_label})
	{
		my @tx = (210,410,675,875);
		my @ty = (460,516,516,460);
		@ty = map {600-$_} @ty;
...
"1001"#AD
	...
	my @tx = (200,400,690,890,320,550,780,410,550,690,345,470,630,755,550);
	my @ty = (330,460,460,330,390,400,390,300,200,300,170,130,130,170,75);
	@ty = map {600-$_} @ty;
...
sub _venn5 
{
	...
	if ($conf->{show_label})
	{
		...
		my $text4x = 200 - $label_font->fetch_text_width($name4)/2;
		...
		$parent->text(x=>$text4x,y=>520,class=>"label",transform=>"rotate(45,200,520)",id=>"label4")->cdata($name4);
